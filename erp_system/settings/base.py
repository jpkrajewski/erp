...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-#(7!")
...
MIDDLEWARE = [
    "erp_system.middleware.performance.LogSlowRequestsMiddleware",
    ...
    "erp_system.middleware.idle_timeout.IdleTimeoutMiddleware",
]
